    ...
    <div style={{ minHeight:'100vh', background:'#08080E', color:TEXT, fontFamily:"'DM Sans',system-ui,sans-serif", display:'flex', flexDirection:'column' }}>
      <style>{`
        ...
        @media (max-width: 600px) {
          ...
          .su-card { padding:28px 20px !important; border-radius:14px !important; }
          .su-main { padding:12px 16px 60px !important; }
        }
      `}</style>
      ...
      {/* ── Main ── */}
      <main className="su-main" style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', padding:'12px 24px 80px', position:'relative', overflow:'hidden' }}>
        <div style={{ position:'absolute', top:'40%', left:'50%', transform:'translate(-50%,-50%)', width:700, height:700, borderRadius:'50%', background:'radial-gradient(circle,rgba(201,168,76,0.04) 0%,transparent 70%)', pointerEvents:'none' }}/>

        <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.5, ease:[0.4,0,0.2,1] }}
          style={{ width:'100%', maxWidth:440, position:'relative', zIndex:1 }}>

          {/* Card */}
          <div className="su-card" style={{ background:'rgba(12,12,20,0.95)', border:`1px solid rgba(255,255,255,0.09)`, borderRadius:18, padding:'40px 40px', boxShadow:'0 40px 80px rgba(0,0,0,0.5)' }}>
